...
public class ViewHolder_LISTENED extends RecyclerView.ViewHolder implements View.OnClickListener {
    private static final String TAG = "ViewHolder_LISTENED";
    ...
    public ViewHolder_LISTENED(@NonNull View itemView) {
        super(itemView);
        view = itemView;
...
//0 initialize views with recyclerview_model.xml
        ...
        //categorycontainerrow1 = itemView.findViewById(R.id.llcategorycontainerrow1id);
        //categorycontainerrow2 = itemView.findViewById(R.id.llcategorycontainerrow2id);
        //TODO aktivieren hier die rwo1,2
