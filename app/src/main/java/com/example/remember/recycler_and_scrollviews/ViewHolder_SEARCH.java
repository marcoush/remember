...
public class ViewHolder_SEARCH extends RecyclerView.ViewHolder implements View.OnClickListener {
    private static final String TAG = "ViewHolder_SEARCH";
    ...
    LinearLayout categorycontainerrow1;    //alt: HorizontalScrollView categoryhsv; LinearLayout categorycontainer;
...
//0 initialize views with recyclerview_search.xml
    ...
    public void onClick(View view) {
        ...
        if (clickListener != null) {
            int position = getAdapterPosition(); //TODO (question) was das macht, hab ich noch nciht ganz gerallt mit adapter positino
